(function () {
    ...
    Level1BosqueState.prototype.preload = function () {
        ...
        //First of all, let's enable the images for multi-texturing:
        //var enabled = this.game.renderer.setTexturePriority(['rato', 'blood', 'items', 'capa_hud', 'interrogacao', 'tiledBosque', 'tiledBosque1']);
    }
